...
public abstract class AbstractClusterInvoker<T> implements Invoker<T> {
     ...
     * 重新选择一个 Invoker 对象
     *
     * 重选，invokers 不是已经被第一次选择了
     * 如果所所有的invokers都被选择，那就选择一个合适的loadbalance策略
     *
     * @param loadbalance
     * @param invocation
     * @param invokers
     ...
     *
     * <p>
     *  如果invokers不为空，初始化自来自于第一个invoke的URL
     *  如果invokers 为空，那么初始化一个默认的LoadBalance（RandomLoadBalance）
     * <p/>
     *
