...
/**
 * AbstractClient
 * 实现 Client 接口，继承 AbstractEndpoint 抽象类，客户端抽象类，
 * 重点实现了公用的重连逻辑，同时抽象了连接等模板方法，供子类实现
 *
 */
public abstract class AbstractClient extends AbstractEndpoint implements Client {
     ...
     * 会调用 {@link org.apache.dubbo.remoting.transport.dispatcher.WrappedChannelHandler} 创建
     */
    ...
    public AbstractClient(URL url, ChannelHandler handler) throws RemotingException {
        ...
        // 默认的超时间隔是2S，1800 意味着警告日志的间隔是一小时
            ...
            Runnable connectStatusCheckCommand = new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        // 超过一定时间未连上，才打印异常日志。并且，仅打印一次。默认五分钟
