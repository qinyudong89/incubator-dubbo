...
public class DubboProtocol extends AbstractProtocol {
     ...
     * 通信服务器集合。其中，Key 为服务器地址，格式为 host:port
     */
    ...
    */ 
    ...
    /** 
    * @Description:  创建并启动通信服务器
    * @Param: [url] 
    * @return: org.apache.dubbo.remoting.exchange.ExchangeServer 
    * @Author: wangsc
    * @Date: 2018/9/18 
    */ 
    ...
    /** 
    * @Description: 获得连接服务提供者的远程通信客户端数组
    * @Param: [url 服务提供者 URL]
    * @return: org.apache.dubbo.remoting.exchange.ExchangeClient[]  远程通信客户端
    * @Author: wangsc
    * @Date: 2018/9/18 
    */ 
